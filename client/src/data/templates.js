// GuestInvitation Templates — hand-picked photo cards plus a generated vector
...
const BASE_TEMPLATES = [
  ...
  { _id: 'gp1', name: 'Gulabi Makhar', slug: 'gulabi-makhar', category: 'ganpati', previewImage: '/templates/ganpati-new-01.png', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'rose-blush', sampleText: { blessing: '|| Shri Ganeshay Namah ||', event: 'Ganesh Chaturthi', date: '14 September 2026' }},
  { _id: 'gp2', name: 'Mandir Darshan', slug: 'mandir-darshan', category: 'ganpati', previewImage: '/templates/ganpati-new-02.png', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'antique-gold', sampleText: { blessing: '|| Ganpati Bappa Morya ||', event: 'Ganesh Chaturthi', date: '14 September 2026' }},
  { _id: 'gp3', name: 'Mor Pankh Bappa', slug: 'mor-pankh-bappa', category: 'ganpati', previewImage: '/templates/ganpati-new-03.png', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'peacock-teal', sampleText: { blessing: '|| Shri Ganeshay Namah ||', event: 'Ganesh Chaturthi', date: '14 September 2026' }},
  { _id: 'gp4', name: 'Bal Ganesha Jhula', slug: 'bal-ganesha-jhula', category: 'ganpati', previewImage: '/templates/ganpati-new-04.png', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'rose-blush', sampleText: { blessing: '|| Bal Ganesh ||', event: 'Ganesh Chaturthi', date: '14 September 2026' }},
  { _id: 'gp5', name: 'Durva Ganpati', slug: 'durva-ganpati', category: 'ganpati', previewImage: '/templates/ganpati-new-05.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'peacock-teal', sampleText: { blessing: '|| Ganpati Bappa Morya ||', event: 'Ganeshotsav', date: '14 September 2026' }},
  { _id: 'gp6', name: 'Dhol Tasha Visarjan', slug: 'dhol-tasha-visarjan', category: 'ganpati', previewImage: '/templates/ganpati-new-06.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'antique-gold', sampleText: { blessing: '|| Ganpati Bappa Morya ||', event: 'Ganesh Visarjan', date: '5 September 2026' }},
  { _id: 'gp7', name: 'Marigold Bappa', slug: 'marigold-bappa', category: 'ganpati', previewImage: '/templates/ganpati-06.png', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'soft-brown', sampleText: { blessing: '|| Shri Ganeshay Namah ||', event: 'Ganesh Chaturthi', date: '14 September 2026' }},
  { _id: 'gp8', name: 'Ocean Bappa', slug: 'ocean-bappa', category: 'ganpati', previewImage: '/templates/ganpati-07.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'soft-brown', sampleText: { blessing: '|| Ganpati Bappa Morya ||', event: 'Ganeshotsav', date: '14 September 2026' }},
  { _id: 'gp9', name: 'Puneri Bappa', slug: 'puneri-bappa', category: 'ganpati', previewImage: '/templates/ganpati-08.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'deep-burgundy', sampleText: { blessing: '|| Shri Ganeshay Namah ||', event: 'Ganeshotsav', date: '14 September 2026' }},
  { _id: 'gp10', name: 'Rose Ganesha', slug: 'rose-ganesha', category: 'ganpati', previewImage: '/templates/tpl-ganpati-2.jpg', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'soft-brown', sampleText: { blessing: '|| Ganpati Bappa Morya ||', event: 'Ganesh Utsav', date: '14 September 2026' }},
  { _id: 'gp11', name: 'Joyful Bappa', slug: 'joyful-bappa', category: 'ganpati', previewImage: '/templates/ganpati-09.png', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'antique-gold', sampleText: { blessing: '|| Ganpati Bappa Morya ||', event: 'Ganesh Chaturthi', date: '14 September 2026' }},
